  ...
  const myQuestions = [
    {
      ...
      question: 'If X = '+X+', then what is X['+a+':'+b+']',
      answers: {
        a: X.slice(a,b),
        b: "Roc",
        c: "Paper",
    ...
    },
    {
      ...
      question: 'If X = '+X+', then what is X['+a+']',
      answers: {
        a: X[a],
        b: "Roc",
        c: "Paper",
    ...
    },
    {
      ...
      question: 'If X = '+X+', and Y = '+Y+' then what is X+Y',
      answers: {
        a: X+Y,
        b: "Roc",
        c: "Paper",
    ...
    },
    {
      ...
      question: 'If X = '+X+', then what is X['+a+':'+b+'] + '+Y,
      answers: {
        a: X.slice(a,b)+Y,
        b: "Roc",
        c: "Paper",
    ...
    },
    {
      ...
      question: 'If X = '+X+', then what is X*'+num,
      answers: {
        a: X.repeat(num),
        b: "Roc",
        c: "Paper",
    ...
    },
    {
      ...
      question: 'What will be the output of len('+X+') ?',
      answers: {
        a: X.length,
        b: 2,
        c: 5,
    ...
    },
    {
      ...
      question: 'What will be the output of lower('+X+') ?',
      answers: {
    ...
    },
    {
      ...
      question: 'What will be the output of upper('+X+') ?',
      answers: {
